...
When bday.py runs, if any of the birthdays in the database match the current date, it will send an SMS alert. Additional adjustments can be made to make the app perform to standard, as follows:
